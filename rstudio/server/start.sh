...
/usr/lib/rstudio-server/bin/rserver --server-user $USERNAME --www-port 8787 --auth-none=0 --auth-pam-helper-path=pam-helper --auth-timeout-minutes=0 --auth-stay-signed-in-days=30
